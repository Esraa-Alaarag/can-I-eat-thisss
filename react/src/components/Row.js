    ...
    return (
      <tbody className="historyRow">
        <tr>
          ...
          <th className='icon'><img alt="egg" src="/can-I-eat-thisss/images/icons/egg-color.png"/></th>
          <th className='icon'><img alt="fish" src="/can-I-eat-thisss/images/icons/fish-color.png"/></th>
          <th className='icon'><img alt="milk" src="/can-I-eat-thisss/images/icons/milk-color.png"/></th>
          <th className='icon'><img alt="peanut" src="/can-I-eat-thisss/images/icons/icons-blackandwhite/peanut-bw.png"/></th>
          <th className='icon'><img alt="sesame" src="/can-I-eat-thisss/images/icons/sesame-color.png"/></th>
          <th className='icon'><img alt="shellfish" src="/can-I-eat-thisss/images/icons/shellfish-color.png"/></th>
          <th className='icon'><img alt="soy" src="/can-I-eat-thisss/images/icons/soy-color.png"/></th>
          <th className='icon'><img alt="treennut" src="/can-I-eat-thisss/images/icons/treenut-color.png"/></th>
          <th className='icon'><img alt="wheat" src="/can-I-eat-thisss/images/icons/wheat-color.png"/></th>
